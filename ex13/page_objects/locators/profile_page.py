class Locators:
    ...
    change_email_message_xpath_locator = '//*[@class ="red"][text()="Вы успешно отписались."]'
    ...
    state_subscribe_message_xpath_locator = '//*[@class="data-table"]/descendant::td[text()="Подписка активна:"]/following-sibling::td[1]'
